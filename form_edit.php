            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    if ($_SESSION['level'] == "admin" AND "suplayer") { ?>
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="penjualan.php">Penjualan</a></li>
...
<form action="proses_edit.php" method="POST" name="form1" value="">
    <?php
    ...
    <div class="form-group">
      ...
      <input type="id" class="form-control" id="id" placeholder="Enter Id" name="id" value="<?php echo $row['id'] ?>">
    </div>
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <input type="username" class="form-control" id="username" placeholder="Enter Username" name="username" value="<?php echo $row['username'] ?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="level" class="form-control" id="level" placeholder="Enter Level" name="level" value="<?php echo $row['level'] ?>">
    </div>
    <input type="submit" class="btn btn-primary" name="spn" value="simpan">
  </form>
</div>
</form>
<?php
