    ...
    <tbody>
      ...
      while($row = $result->fetch_assoc()) {
        ...
        <tr align="center">
            ...
            <td><?=  $row['password']; ?></td>
            <td><?=  $row['level'];?></td>
            <td><a href="proses_hapus.php?id=<?php echo $row['id']; ?>"> Hapus </a> | <a href="form_edit.php?id=<?php echo $row['id']; ?>"> Edit </a></td>
        </tr>
        <?php $i++;  ?>
        <?php
      }
...
?>
<div class="container" style="color: white;padding: 15px 20px 15px 20px;">
 <ul class="nav justify-content-center">
    <li class="nav-item">
      <a class="btn btn-primary" href="form_tambah.php"> Tambahkan Data </a>
    </li>
</div>
