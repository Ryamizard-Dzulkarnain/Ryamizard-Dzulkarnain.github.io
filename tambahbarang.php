            ...
            <div class="box-body">  
                ...
                include 'connect.php';
                    if (isset($_POST['save'])) {
                        ...
                        $sql="INSERT INTO barang(kd_barang,nama_barang,satuan,harga_jual,harga_beli,stok) 
                ...
                <form method="POST" id="forminput" enctype="multipart/form-data">
                    ...
                    <a href="barang.php" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Back to barang</a>
                </form>
            </div>
        </div>
    </div>
