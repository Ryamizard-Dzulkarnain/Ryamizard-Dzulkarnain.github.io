                    ...
                    <table class="table table-striped table-bordered table-hover" id="tabelku">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX" align="center">
                                ...
                                <td><?=  $row['stok']; ?></td>
                                <td>
                                    <a href="ubahbarang.php?id=<?php echo $row['kd_barang']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit</a>
                                    <a href="hpsbarang.php?hapus=<?php echo $row['kd_barang']; ?>" class="btn btn-danger btn-xs" id="alertHapus"><i class="fa fa-trash"></i> Hapus</a>
                                </td>
                            </tr>
                            <?php $i++;  ?>
                            <?php } ?>
...
?>
            <div class="panel-footer" align="center">
                <a href="tambahbarang.php" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Barang</a>
            </div>
        </div>
    <!-- Right Panel -->
