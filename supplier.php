...
include 'connect.php';
    #Menampilkan Data
    $tampil = "SELECT * FROM login WHERE level='suplayer'";
                    ...
                    while($row = $result->fetch_assoc()) {
                     ?>
                            <tr class="odd gradeX" align="center">
                                ...
                                <td><?=  $row['password']; ?></td>
                                <td><?=  $row['level'];?></td>
                                <td><a href="formeditsup.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit</a>
                                    <a href="hpssup.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-xs" id="alertHapus"><i class="fa fa-trash"></i> Hapus</a></td>
                                </td>
                            </tr>
                             <?php $i++;  ?>
                            <?php } ?>
...
?>
            <div class="panel-footer" align="center">
                <a href="formtambahsup.php" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Supplier</a>
            </div>
        </div>
